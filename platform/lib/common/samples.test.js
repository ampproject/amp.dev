...
jest.mock('../../../dist/static/samples/samples.json', () => (
  {
    'websites': {
      'categories': [
        {
          ...
          'examples': [
            {
              'title': 'No Component',
              'url': 'http://localhost:8084/documentation/examples/introduction/amp-img',
            },
          ],
        },
        {
          ...
          'examples': [
            {
              'title': 'amp-3d-gltf',
              'url': 'http://localhost:8084/documentation/examples/components/amp-3d-gltf',
            },
            {
              'title': 'amp-access-laterpay',
              'url': 'http://localhost:8084/documentation/examples/components/amp-access-laterpay/',
            },
          ],
        },
      ],
          ...
          'examples': [
            {
              ...
              'url': 'http://localhost:8084/documentation/examples/introduction/stories_in_amp',
            },
          ],
        },
      ],
...
test('getExamplePreviewUrl', () => {
  ...
  expect(link).toBe('http://localhost:8084/documentation/examples/introduction/stories_in_amp/');
});

test('getPlaygroundUrlForPreviewLink', () => {
  const link = samples.getPlaygroundUrlForPreviewLink('http://localhost:8084/documentation/examples/introduction/stories_in_amp/');
  expect(link).toBe('http://localhost:8083/?url=http%3A%2F%2Flocalhost%3A8084%2Fdocumentation%2Fexamples%2Fintroduction%2Fstories_in_amp%2F');
});

test('getPlaygroundUrlForExampleLink', () => {
  const link = samples.getPlaygroundUrlForExampleLink('http://localhost:8080/documentation/examples/introduction/stories_in_amp/?format=websites');
  expect(link).toBe('http://localhost:8083/?url=http%3A%2F%2Flocalhost%3A8084%2Fdocumentation%2Fexamples%2Fintroduction%2Fstories_in_amp%2F');
});

test('getPlaygroundUrlForExampleLink with locale', () => {
  const link = samples.getPlaygroundUrlForExampleLink('http://localhost:8080/pt_br/documentation/examples/introduction/stories_in_amp/?format=websites');
  expect(link).toBe('http://localhost:8083/?url=http%3A%2F%2Flocalhost%3A8084%2Fdocumentation%2Fexamples%2Fintroduction%2Fstories_in_amp%2F');
});


test('getRelativeExampleUrlForPreviewLink', () => {
  let link = samples.getRelativeExampleUrlForPreviewLink('http://localhost:8084/documentation/examples/introduction/stories_in_amp/', 'websites');
  expect(link).toBe('/documentation/examples/introduction/stories_in_amp/?format=websites');
  link = samples.getRelativeExampleUrlForPreviewLink('http://localhost:8084/documentation/examples/introduction/stories_in_amp', 'ads');
  expect(link).toBe('/documentation/examples/introduction/stories_in_amp/?format=ads');
});
...
test('read the sample sitemap', () => {
  ...
  expect(sitemap['websites'].categories[0].examples[0].title).toBe('No Component');
});
