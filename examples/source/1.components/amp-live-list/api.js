...
const blogItems = [
  ...
  newPost('Mountains reflecting on a lake.', 'landscape_mountains_1280x657.jpg', 2),
  newPost('A road leading to a lake with mountains on the back.', 'landscape_lake_1280x857.jpg', 3),
  newPost('Forested hills with a grey sky in the background.', 'landscape_trees_1280x960.jpg', 4),
  newPost('Scattered houses in a mountain village.', 'landscape_village_1280x853.jpg', 5),
  newPost('A deep canyon.', 'landscape_canyon_1280x1700.jpg', 6),
  newPost('A desert with mountains in the background.', 'landscape_desert_1280x853.jpg', 7),
