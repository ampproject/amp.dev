...
Oltre alle condizioni riportate sopra, `visibilitySpec` attiva anche determinate variabili documentate [qui](./analytics-vars.md#visibility-variables).
