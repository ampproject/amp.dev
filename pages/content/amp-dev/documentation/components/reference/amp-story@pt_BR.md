...
Para ver os componentes gerais mais utilizáveis, consulte a [lista de filhos permitidos]({{g.doc('/content/amp-dev/documentation/components/reference/amp-story.md', locale=doc.locale).url.path}}#children).
