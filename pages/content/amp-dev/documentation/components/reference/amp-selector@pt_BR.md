...
Para limpar todas as seleções quando se toca ou clica em um elemento, defina o atributo de ação [`on`](https://github.com/ampproject/amphtml/blob/master/spec/amp-actions-and-events.md) no elemento e especifique o `id` seletor de AMP com o método de ação `clear`.
...
Leia mais sobre [ações e eventos de AMP](https://github.com/ampproject/amphtml/blob/master/spec/amp-actions-and-events.md).
