...
<table>
  ...
  <tr>
    ...
    <td><div><a href="../../../documentation/guides-and-tutorials/learn/experimental.md">Экспериментальная функция</a></div></td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td><ul>
      ...
      <li><a href="../../../documentation/guides-and-tutorials/start/visual_story/index.md">Руководство</a> по созданию визуальных AMP-историй.</li>
    </ul></td>
  </tr>
</table>
...
К формату HTML для AMP-историй применимы те же [требования](../../../documentation/guides-and-tutorials/learn/spec/amphtml.md#required-markup), что и к обычным документам AMPHTML. Есть также несколько дополнительных правил:
...
Поддерживаются те же поставщики, что и для компонента [amp-social-share](amp-social-share.md).

У каждого из поставщиков свой список поддерживаемых параметров ([см. `data-param-*`](amp-social-share.md#data-param-%2a)). Объект конфигурации принимает эти параметры без префикса `data-param-`. Например, `data-param-app_id` отображается в нем как `app_id`.
...
Более широко используемые компоненты перечислены в [списке допустимых дочерних элементов](amp-story.md#children).
...
* [Руководство по созданию визуальных AMP-историй](../../../documentation/guides-and-tutorials/start/visual_story/index.md)
* [Примеры на сайте AMP By Example](https://ampbyexample.com/stories/#stories/introduction)
* [Рекомендации по созданию AMP-истории](../../../documentation/guides-and-tutorials/develop/amp_story_best_practices.md)
