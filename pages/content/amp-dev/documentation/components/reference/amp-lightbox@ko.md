...
일반 AMP 문서에서 `amp-lightbox` 사용과 [AMPHTML로 작성된 광고](https://github.com/ampproject/amphtml/blob/master/extensions/amp-a4a/amp-a4a-format.md)를 사용하는 데는 몇 가지 차이점이 있습니다.
