...
We're not going to build this product page inside of our Chico's Cheese Bikes project. Instead, you can use <a href="https://glitch.com/edit/#!/snapdragon-melody" target="_blank">this</a> Glitch as a starting point for this exercise. **Note**: Don't forget to remix it so you can edit! The Glitch contains:
...
The solution can be found in <a href="https://glitch.com/edit/#!/potent-custard" target="_blank">this</a> Glitch example. The portion of the page containing the changes should look like this:
