...
If you’d like to dive right in, you can start the course [here]({{g.doc('/content/amp-dev/documentation/guides-and-tutorials/courses/advanced-course/index.md', locale=doc.locale).url.path}}). If you’d like a link to the finished code samples from the intermediate course, you can find those [here](https://glitch.com/~enshrined-eyebrow).
