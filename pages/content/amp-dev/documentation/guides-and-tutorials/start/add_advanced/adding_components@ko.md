...
[AMP by Example의 라이브 데모],[`amp-fit-text`]({{g.doc('/content/amp-dev/documentation/components/reference/amp-fit-text.md', locale=doc.locale).url.path}}).url.path}})에 관해 자세히 알아보세요.
