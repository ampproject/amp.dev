...
Pelajari lebih lanjut di panduan [Memvalidasi halaman AMP]({{g.doc('/content/amp-dev/documentation/guides-and-tutorials/learn/validate.md', locale=doc.locale).url.path}}).
[/tip]
