...
[تعرّف على المزيد بشأن التحقق]({{g.doc('/content/amp-dev/documentation/guides-and-tutorials/learn/validation-workflow/index.md', locale=doc.locale).url.path}})، وما يتعين فعله عند مصادفة أخطاء.
