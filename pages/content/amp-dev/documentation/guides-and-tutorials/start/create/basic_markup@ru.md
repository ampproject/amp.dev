...
Документ AMP HTML ДОЛЖЕН:
  ...
  - Содержать в теге заголовка тег `<meta name="viewport" content="width=device-width,minimum-scale=1,initial-scale=1">`. Также рекомендуется включить в него значение initial-scale=1.
