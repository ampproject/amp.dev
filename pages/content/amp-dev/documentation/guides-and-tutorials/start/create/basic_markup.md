...
[tip type="tip"]
Use the [AMP Boilerplate Generator](http://amp.dev/boilerplate) to quickly get started with creating new AMP pages.
[/tip]
...
| Contain the [AMP boilerplate code]({{g.doc('/content/amp-dev/documentation/guides-and-tutorials/learn/spec/amp-boilerplate.md', locale=doc.locale).url.path}}) in their `<head>` tag.  | CSS boilerplate to initially hide the content until AMP JS is loaded. |
