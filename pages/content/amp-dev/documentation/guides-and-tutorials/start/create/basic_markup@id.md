...
| Berisi tag `<script async src="https://ampjs.org/v0.js"></script>` di dalam `<head>`-nya. Sebagai praktik terbaik, Anda seharusnya menyertakan skrip ini sedini mungkin di dalam `<head>`. | Menyertakan dan memuat perpustakan JS AMP.                                                                                                                                                                                                                                          |
