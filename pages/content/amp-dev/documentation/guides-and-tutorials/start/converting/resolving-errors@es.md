...
Leer más: Aprenda más sobre el sistema de distribución de AMP en [AMP Layout Specification]({{g.doc('/content/amp-dev/documentation/guides-and-tutorials/learn/amp-html-layout.md', locale=doc.locale).url.path}}).
