...
<table class="noborder">
  <tr>
    <td width="60%">
      ...
      <ul>
        <li><b>Layer 1</b>: Implements the <a href="/docs/getting_started/visual_story/create_cover_page.html#fill"><code>fill</code></a> template, and contains a responsive <a href="{{g.doc('/content/amp-dev/documentation/components/reference/amp-img.md', locale=doc.locale).url.path}}"><code>amp-img</code></a> (<code class="filename">dog.jpg</code>, 720 x 1280px).</li>
