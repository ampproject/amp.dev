...
<div class="prev-next-buttons">
  <a class="button prev-button" href="{{g.doc('/content/amp-dev/documentation/guides-and-tutorials/start/visual_story/start_story.html', locale=doc.locale).url.path}}"><span class="arrow-prev">前へ</span></a>
