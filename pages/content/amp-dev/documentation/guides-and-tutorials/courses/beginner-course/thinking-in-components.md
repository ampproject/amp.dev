...
[tip type="note"]
**Note**: If you want to know more about AMP’s automatic optimizations, you can read about lazy-loading and pre-rendering in AMP in the [appendix]({{g.doc('/content/amp-dev/documentation/guides-and-tutorials/courses/beginner-course/appendix.md', locale=doc.locale).url.path}}).
[/tip]
