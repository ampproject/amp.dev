...
*   **通过[支持的播放器](/zh_cn/docs/reference/components.html#media)或 [`amp-iframe`]({{g.doc('/content/amp-dev/documentation/components/reference/amp-iframe.md', locale=doc.locale).url.path}}) 在视频内容中展示广告**，以通过各种类型的内容创收。
