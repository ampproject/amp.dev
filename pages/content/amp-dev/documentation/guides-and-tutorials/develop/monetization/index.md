...
*   **Place ads in your video content** via [supported players]({{g.doc('/content/amp-dev/documentation/components.html', locale=doc.locale).url.path}}#media) or [`amp-iframe`]({{g.doc('/content/amp-dev/documentation/components/reference/amp-iframe.md', locale=doc.locale).url.path}}) to enable revenue on all types of content.
