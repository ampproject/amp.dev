...
واستخدام [`srcset`]({{g.doc('/content/amp-dev/documentation/guides-and-tutorials/style_and_layout/style_pages.md', locale=doc.locale).url.path}}) لتوضيح
...
(راجع أيضًا [CSS المتوافقة]({{g.doc('/content/amp-dev/documentation/guides-and-tutorials/style_and_layout/style_pages.md', locale=doc.locale).url.path}})).
...
تعرّف على المزيد حول [التنسيقات المتوافقة في AMP]({{g.doc('/content/amp-dev/documentation/guides-and-tutorials/style_and_layout/control_layout.md', locale=doc.locale).url.path}}).
...
تعرّف على المزيد من المعلومات حول كيفية [التحقق من صحة صفحات AMP]({{g.doc('/content/amp-dev/documentation/guides-and-tutorials/learn/validate.md', locale=doc.locale).url.path}})،
