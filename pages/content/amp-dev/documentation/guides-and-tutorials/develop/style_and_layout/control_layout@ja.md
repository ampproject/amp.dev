...
[AMP By Example のライブデモ],[`amp-img`]({{g.doc('/content/amp-dev/documentation/components/reference/amp-img.md', locale=doc.locale).url.path}}).url.path}}) の動作を比較したライブデモをご覧ください。
