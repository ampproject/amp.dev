...
Dica: Veja uma explicação detalhada sobre esse fluxo na [documentação sobre amp-access]({{g.doc('/content/amp-dev/documentation/components/reference/amp-access.md', locale=doc.locale).url.path}}#login-flow).
