...
[데모]({{g.doc('/content/amp-dev/documentation/examples/documentation/Using_the_AMP_URL_API.md', locale=doc.locale).url.path}}))과 일치하는 AMP HTML URL을 가져올 수 있습니다. 여기서 URL은
