...
funcionalidades adicionais que não passariam na [validação de AMP]({{g.doc('/content/amp-dev/documentation/guides-and-tutorials/learn/validate.md', locale=doc.locale).url.path}}) se fossem usadas de outra forma. Por exemplo:
