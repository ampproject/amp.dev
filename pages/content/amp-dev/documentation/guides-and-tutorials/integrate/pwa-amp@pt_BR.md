...
Leia mais: Saiba como [ativar recursos de PWA]({{g.doc('/content/docs/integration/pwa-amp/amp-as-pwa.md', locale=doc.locale).url.path}}) para suas páginas AMP.
...
Leia mais: Saiba como [conectar AMP a um PWA]({{g.doc('/content/docs/integration/pwa-amp/amp-to-pwa.md', locale=doc.locale).url.path}}) usando `amp-install-serviceworker`.
