...
広告サーバーでは、AMP との統合により、[AMP HTML](../../../documentation/guides-and-tutorials/learn/intro-to-amphtml-ads.md) 広告と通常の HTML 広告の両方を AMP ページに配信できます。
...
[tip type="note"]
この [`amp-ad`](../../../documentation/components/reference/amp-ad.md) の実装で、従来の HTML 広告と AMP HTML 広告の**両方**を表示することができます。
[/tip]
