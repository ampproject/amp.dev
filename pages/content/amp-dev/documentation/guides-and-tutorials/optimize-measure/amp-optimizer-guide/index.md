...
- [create-amp-page-starter](https://github.com/bemit/create-amp-page-starter) via [AMP Optimizer (Node.js)](node-amp-optimizer.md) with [https://www.netlifycms.org/](https://www.netlifycms.org/)
