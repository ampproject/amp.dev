...
[спецификации amp-analytics](/ru/docs/reference/components/amp-analytics.html).
...
[запроса](/ru/docs/analytics/deep_dive_analytics.html#какие-данные-должны-быть-отправлены:-атрибут-requests).
...
[справочной документации по amp-analytics](/ru/docs/reference/components/amp-analytics.html)).
...
Атрибут [extraUrlParams](/ru/docs/reference/components/amp-analytics.html#extra-url-params)
