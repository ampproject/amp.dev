...
O formato AMP para E-mail oferece [um subconjunto dos componentes AMP](https://github.com/ampproject/amphtml/blob/main/spec/email/amp-email-components.md) que você pode usar em mensagens de e-mail. Os destinatários de e-mails de AMP podem visualizar e interagir com os componentes de AMP diretamente no e-mail.
...
_Para mais informações, veja [Estrutura e renderização de E-mails AMP](https://github.com/ampproject/amphtml/blob/main/spec/email/amp-email-structure.md)._

## Componentes AMP suportados <a name="supported-amp-components"></a>

_Veja [AMP para E-mail: Componentes Suportados](https://github.com/ampproject/amphtml/blob/main/spec/email/amp-email-components.md)._

## Requisitos de HTML <a name="html-requirements"></a>

_Veja [HTML Suportado em AMP para Email](https://github.com/ampproject/amphtml/blob/main/spec/email/amp-email-html.md)._
...
_Veja [CSS Suportado em AMP para Email](https://github.com/ampproject/amphtml/blob/main/spec/email/amp-email-css.md)._
...
Para obter suporte e feedback sobre o AMP para E-mail, por favor, utilize o seguinte canal: [ongoing-participation](https://github.com/ampproject/amphtml/blob/main/CONTRIBUTING.md#ongoing-participation)
