...
Este documento descreve os recursos do CSS que são atualmente compatíveis com os e-mails AMP.

## Aplicando CSS <a name="applying-css"></a>

### Folha de estilos interna <a name="internal-stylesheet"></a>

Ao usar uma folha de estilo interna, o CSS é especificado dentro de uma única tag `<style amp-custom>` localizada na tag `<head>` do e-mail.

### Estilos inline <a name="inline-styles"></a>

Além de uma folha de estilo interna, estilos embutidos podem ser especificados em qualquer elemento usando o atributo [`style`](https://developer.mozilla.org/en-US/docs/Web/HTML/Global_attributes#attr-style).

### Folha de estilos externa <a name="external-stylesheet"></a>

Folhas de estilo externas **não** são suportadas em AMP para E-mail.

O uso de `<link rel="stylesheet" href="...">` não é permitido em lugar algum do e-mail.

## Seletores CSS suportados <a name="supported-css-selectors"></a>
...
## Propriedades CSS suportadas <a name="supported-css-properties"></a>
...
### Restrições adicionais <a name="additional-restrictions"></a>
...
A única [regra @](https://developer.mozilla.org/en-US/docs/Web/CSS/At-rule) suportada no momento é `@media`. Veja [Media features](#media-features) para mais informações.

### Fontes personalizadas (`@font-face`) <a name="custom-fonts-font-face"></a>

Fontes personalizadas **não** são suportadas em AMP para E-mail.
