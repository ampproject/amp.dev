...
## Áp dụng CSS <a name="applying-css"></a>

### Stylesheet nội bộ <a name="internal-stylesheet"></a>

Khi sử dụng một stylesheet nội bộ, CSS được quy định trong một thẻ `<style amp-custom>` nằm trong thẻ `<head>` của email.

### Phong cách inline <a name="inline-styles"></a>

Ngoài một stylesheet nội bộ, các phong cách inline có thể được quy định trên bất kỳ yếu tố nào sử dụng [thuộc tính `style`](https://developer.mozilla.org/en-US/docs/Web/HTML/Global_attributes#attr-style).

### Stylesheet bên ngoài <a name="external-stylesheet"></a>
...
## Các bộ chọn CSS được hỗ trợ <a name="supported-css-selectors"></a>

### Các bộ chọn đơn giản <a name="simple-selectors"></a>

- [Bộ chọn loại](https://developer.mozilla.org/en-US/docs/Web/CSS/Type_selectors) `elementname`
- [Bộ chọn lớp](https://developer.mozilla.org/en-US/docs/Web/CSS/Class_selectors) `.classname`
- [Bộ chọn ID](https://developer.mozilla.org/en-US/docs/Web/CSS/ID_selectors) `#idname`
- [Bộ chọn đa năng](https://developer.mozilla.org/en-US/docs/Web/CSS/Universal_selectors) `*`
- [Bộ chọn thuộc tính](https://developer.mozilla.org/en-US/docs/Web/CSS/Attribute_selectors) `[attr=value]`

### Các bộ kết hợp <a name="combinators"></a>

- [Bộ kết hợp anh em liền kề](https://developer.mozilla.org/en-US/docs/Web/CSS/Adjacent_sibling_combinator) `A + B`
- [Bộ kết hợp anh em tổng quát](https://developer.mozilla.org/en-US/docs/Web/CSS/General_sibling_combinator) `A ~ B`
- [Bộ kết hợp con](https://developer.mozilla.org/en-US/docs/Web/CSS/Child_combinator) `A > B`
- [Bộ kết hợp con cháu](https://developer.mozilla.org/en-US/docs/Web/CSS/Descendant_combinator) `A B`

### Các lớp giả <a name="pseudo-classes"></a>
...
## Các thuộc tính CSS được hỗ trợ <a name="supported-css-properties"></a>
...
### Các hạn chế bổ sung <a name="additional-restrictions"></a>
...
[At-rule](https://developer.mozilla.org/en-US/docs/Web/CSS/At-rule) (Quy tắc @) duy nhất hiện được hỗ trợ là `@media`. Xem [Các tính năng đa phương tiện](#media-features) để biết thêm thông tin.

### Các phông chữ tùy chỉnh (`@font-face`) <a name="custom-fonts-font-face"></a>

Các phông chữ tùy chỉnh **không** được hỗ trợ trong AMP cho Email.

## Các tính năng đa phương tiện <a name="media-features"></a>
