...
## CSS uygulaması <a name="applying-css"></a>

### Dahili stil sayfası <a name="internal-stylesheet"></a>
...
## Desteklenen CSS seçicileri <a name="supported-css-selectors"></a>

### Basit seçiciler <a name="simple-selectors"></a>

- [Tip seçici](https://developer.mozilla.org/en-US/docs/Web/CSS/Type_selectors) `elementname`
- [Sınıf seçici](https://developer.mozilla.org/en-US/docs/Web/CSS/Class_selectors) `.classname`
- [ID seçici](https://developer.mozilla.org/en-US/docs/Web/CSS/ID_selectors) `#idname`
- [Evrensel seçici](https://developer.mozilla.org/en-US/docs/Web/CSS/Universal_selectors) `*`
- [Öznitelik seçici](https://developer.mozilla.org/en-US/docs/Web/CSS/Attribute_selectors) `[attr=value]`

### Birleştiriciler <a name="combinators"></a>

- [Bitişik sibling birleştirici](https://developer.mozilla.org/en-US/docs/Web/CSS/Adjacent_sibling_combinator) `A + B`
- [Genel sibling birleştirici](https://developer.mozilla.org/en-US/docs/Web/CSS/General_sibling_combinator) `A ~ B`
- [Child birleştirici](https://developer.mozilla.org/en-US/docs/Web/CSS/Child_combinator) `A > B`
- [Descendant birleştirici](https://developer.mozilla.org/en-US/docs/Web/CSS/Descendant_combinator) `A B`

### Sözde sınıflar <a name="pseudo-classes"></a>
...
## Desteklenen CSS özellikleri <a name="supported-css-properties"></a>
...
### Ek kısıtlamalar <a name="additional-restrictions"></a>
...
## Medya özellikleri <a name="media-features"></a>
