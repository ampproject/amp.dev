...
## Cómo implementar las CSS <a name="applying-css"></a>

### Hojas de estilo internas <a name="internal-stylesheet"></a>
...
### Estilos en línea <a name="inline-styles"></a>

Además de las hojas de estilo internas, también pueden definirse estilos en línea para cualquier elemento mediante el [atributo`style` ](https://developer.mozilla.org/en-US/docs/Web/HTML/Global_attributes#attr-style).

### Hojas de estilo externas <a name="external-stylesheet"></a>
...
## Selectores que son compatibles con las CSS <a name="supported-css-selectors"></a>

### Selectores sencillos <a name="simple-selectors"></a>

- [Tipo de selector](https://developer.mozilla.org/en-US/docs/Web/CSS/Type_selectors) `elementname`
- [Clase del selector](https://developer.mozilla.org/en-US/docs/Web/CSS/Class_selectors) `.classname`
- [ID del selector](https://developer.mozilla.org/en-US/docs/Web/CSS/ID_selectors) `#idname`
- [Selector universal](https://developer.mozilla.org/en-US/docs/Web/CSS/Universal_selectors) `*`
- [Selector de atributos](https://developer.mozilla.org/en-US/docs/Web/CSS/Attribute_selectors) `[attr=value]`

### Combinadores <a name="combinators"></a>

- [Combinador de hermanos adyacentes](https://developer.mozilla.org/en-US/docs/Web/CSS/Adjacent_sibling_combinator) `A + B`
- [Combinador de hermanos generales](https://developer.mozilla.org/en-US/docs/Web/CSS/General_sibling_combinator) `A ~ B`
- [Combinador hijo](https://developer.mozilla.org/en-US/docs/Web/CSS/Child_combinator) `A > B`
- [Combinador descendiente](https://developer.mozilla.org/en-US/docs/Web/CSS/Descendant_combinator) `A B`

### Pseudoclases <a name="pseudo-classes"></a>
...
## Propiedades que son compatibles con las CSS <a name="supported-css-properties"></a>
...
### Restricciones adicionales <a name="additional-restrictions"></a>

Las siguientes propiedades de las CSS tienen restricciones adicionales:

| Propiedad                                                                   | Restricciones                                                                                  |
| --------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------- |
| [`cursor`](https://developer.mozilla.org/en-US/docs/Web/CSS/cursor)         | Los únicos valores que se permiten son `pointer` e `initial`.                                  |
| [`filter`](https://developer.mozilla.org/en-US/docs/Web/CSS/filter)         | `url()` no está permitida.                                                                     |
| [`transition`](https://developer.mozilla.org/en-US/docs/Web/CSS/transition) | Solamente `opacity`, `transform`, `visibility` y `offset-distance` pueden generar animaciones. |
| [`visibility`](https://developer.mozilla.org/en-US/docs/Web/CSS/visibility) | Los únicos valores que se permiten son `hidden`, `visible` e `initial`.                        |
| [`z-index`](https://developer.mozilla.org/en-US/docs/Web/CSS/z-index)       | Solo se permiten los valores entre -100 y 100.                                                 |

## Reglas at <a name="at-rules"></a>

La única [regla at](https://developer.mozilla.org/en-US/docs/Web/CSS/At-rule) actualmente compatible es `@media`. Consulte las [funciones de medios](#media-features) para obtener más información.

### Fuentes personalizadas (`@font-face`) <a name="custom-fonts-font-face"></a>

Las fuentes personalizadas **no** son compatibles con AMP for Email.

## Funciones de medios <a name="media-features"></a>

A continuación, se muestra una lista de [funciones de medios](https://developer.mozilla.org/en-US/docs/Web/CSS/Media_Queries/Using_media_queries#Media_features) que son compatibles para integrar reglas condicionales mediante consultas en `@media`.
