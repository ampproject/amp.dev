...
<!--
This file is imported from https://github.com/ampproject/amphtml/blob/main/docs/spec/email/amp-email-css.md.
...
Questo documento descrive le funzionalità CSS attualmente supportate nelle e-mail AMP.

## Applicazione di CSS <a name="applying-css"></a>

### Fogli di stile interno <a name="internal-stylesheet"></a>

Utilizzando fogli di stile interni, il codice CSS viene specificato all'interno di un singolo tag `<style amp-custom>` situato nel tag `<head>` dell'email.

### Stili inline <a name="inline-styles"></a>

Oltre ai fogli di stile interni, è possibile specificare elementi di stile inline su qualsiasi elemento utilizzando l'[attributo `style`](https://developer.mozilla.org/en-US/docs/Web/HTML/Global_attributes#attr-style).

### Fogli di stile esterni <a name="external-stylesheet"></a>

I fogli di stile esterni **non** sono supportati in AMP per e-mail.

L'uso di `<link rel="stylesheet" href="...">` non è consentito in nessun punto delle e-mail.

## Selettori CSS supportati <a name="supported-css-selectors"></a>

### Selettori semplici <a name="simple-selectors"></a>

- [Selettore di tipo](https://developer.mozilla.org/en-US/docs/Web/CSS/Type_selectors) `elementname`
- [Selettore di classi](https://developer.mozilla.org/en-US/docs/Web/CSS/Class_selectors) `.classname`
- [Selettore ID](https://developer.mozilla.org/en-US/docs/Web/CSS/ID_selectors) `#idname`
- [Selettore universale](https://developer.mozilla.org/en-US/docs/Web/CSS/Universal_selectors) `*`
- [Selettore di attributi](https://developer.mozilla.org/en-US/docs/Web/CSS/Attribute_selectors) `[attr=value]`

### Combinatori <a name="combinators"></a>

- [Combinatore di elementi di pari livello adiacenti](https://developer.mozilla.org/en-US/docs/Web/CSS/Adjacent_sibling_combinator) `A + B`
- [Combinatore di elementi di pari livello generali](https://developer.mozilla.org/en-US/docs/Web/CSS/General_sibling_combinator) `A ~ B`
- [Combinatore di elementi figli](https://developer.mozilla.org/en-US/docs/Web/CSS/Child_combinator) `A > B`
- [Combinatore di discendenti](https://developer.mozilla.org/en-US/docs/Web/CSS/Descendant_combinator) `A B`

### Pseudo-classi <a name="pseudo-classes"></a>
...
## Proprietà CSS supportate <a name="supported-css-properties"></a>
...
### Restrizioni aggiuntive <a name="additional-restrictions"></a>

Le seguenti proprietà CSS hanno limitazioni aggiuntive:

| Proprietà                                                                   | Restrizioni                                                                         |
| --------------------------------------------------------------------------- | ----------------------------------------------------------------------------------- |
| [`cursor`](https://developer.mozilla.org/en-US/docs/Web/CSS/cursor)         | Gli unici valori consentiti sono `pointer` e `initial`.                             |
| [`filter`](https://developer.mozilla.org/en-US/docs/Web/CSS/filter)         | `url()` non è consentito.                                                           |
| [`transition`](https://developer.mozilla.org/en-US/docs/Web/CSS/transition) | È possibile animare solo `opacity`, `transform` , `visibility` e `offset-distance`. |
| [`visibility`](https://developer.mozilla.org/en-US/docs/Web/CSS/visibility) | Gli unici valori consentiti sono `hidden`, `visible` e `initial`.                   |
| [`z-index`](https://developer.mozilla.org/en-US/docs/Web/CSS/z-index)       | Sono consentiti solo valori compresi tra -100 e 100.                                |

## At-rule <a name="at-rules"></a>

L'unica [at-rule](https://developer.mozilla.org/en-US/docs/Web/CSS/At-rule) attualmente supportata è `@media`. Consultare le [Funzionalità multimediali](#media-features) per ulteriori informazioni.

### Caratteri personalizzati (`@font-face`) <a name="custom-fonts-font-face"></a>

I caratteri personalizzati **non** sono supportati in AMP per email.

## Funzionalità multimediali <a name="media-features"></a>

Elenco delle [funzionalità multimediali](https://developer.mozilla.org/en-US/docs/Web/CSS/Media_Queries/Using_media_queries#Media_features) supportate per l'applicazione condizionale delle regole tramite query `@media`.
