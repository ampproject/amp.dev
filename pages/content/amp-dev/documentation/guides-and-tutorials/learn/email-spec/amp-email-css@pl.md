...
## Stosowanie CSS <a name="applying-css"></a>

### Wewnętrzny arkusz stylów <a name="internal-stylesheet"></a>
...
### Style inline <a name="inline-styles"></a>

Oprócz stosowania wewnętrznego arkusza stylów, można określać style inline w dowolnym elemencie za pomocą atrybutu [`style`](https://developer.mozilla.org/en-US/docs/Web/HTML/Global_attributes#attr-style).

### Zewnętrzny arkusz stylów <a name="external-stylesheet"></a>
...
## Obsługiwane selektory CSS <a name="supported-css-selectors"></a>

### Proste selektory <a name="simple-selectors"></a>

- [Selektor typu](https://developer.mozilla.org/en-US/docs/Web/CSS/Type_selectors) `elementname`
- [Selektor klasy](https://developer.mozilla.org/en-US/docs/Web/CSS/Class_selectors) `.classname`
- [Selektor identyfikatora](https://developer.mozilla.org/en-US/docs/Web/CSS/ID_selectors) `#idname`
- [Selektor uniwersalny](https://developer.mozilla.org/en-US/docs/Web/CSS/Universal_selectors) `*`
- [Selektor atrybutu](https://developer.mozilla.org/en-US/docs/Web/CSS/Attribute_selectors) `[attr=value]`

### Kombinatory <a name="combinators"></a>

- [Kombinator sąsiadujących elementów równorzędnych](https://developer.mozilla.org/en-US/docs/Web/CSS/Adjacent_sibling_combinator) `A + B`
- [Kombinator ogólny elementów równorzędnych](https://developer.mozilla.org/en-US/docs/Web/CSS/General_sibling_combinator) `A ~ B`
- [Kombinator elementów podrzędnych](https://developer.mozilla.org/en-US/docs/Web/CSS/Child_combinator) `A > B`
- [Kombinator elementów potomnych](https://developer.mozilla.org/en-US/docs/Web/CSS/Descendant_combinator) `A B`

### Pseudoklasy <a name="pseudo-classes"></a>
...
## Obsługiwane właściwości CSS <a name="supported-css-properties"></a>
...
### Dodatkowe ograniczenia <a name="additional-restrictions"></a>

Następujące właściwości CSS mają dodatkowe ograniczenia:

| Właściwość                                                                  | Ograniczenia                                                                                 |
| --------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------- |
| [`cursor`](https://developer.mozilla.org/en-US/docs/Web/CSS/cursor)         | Jedyne dozwolone wartości to `pointer` i `initial`.                                          |
| [`filter`](https://developer.mozilla.org/en-US/docs/Web/CSS/filter)         | Konstruktor `url()` jest niedozwolony.                                                       |
| [`transition`](https://developer.mozilla.org/en-US/docs/Web/CSS/transition) | Animować można jedynie właściwości `opacity`, `transform`, `visibility` i `offset-distance`. |
| [`visibility`](https://developer.mozilla.org/en-US/docs/Web/CSS/visibility) | Jedyne dozwolone wartości to `hidden`, `visible` i `initial`.                                |
| [`z-index`](https://developer.mozilla.org/en-US/docs/Web/CSS/z-index)       | Dozwolone są jedynie wartości z zakresu od -100 do 100.                                      |

## Reguły at-rules <a name="at-rules"></a>

Jedyna obecnie obsługiwaną [regułą at-rule](https://developer.mozilla.org/en-US/docs/Web/CSS/At-rule) jest `@media`. Więcej informacji zawiera sekcja [Funkcje media](#media-features).

### Czcionki niestandardowe (`@font-face`) <a name="custom-fonts-font-face"></a>

Czcionki niestandardowe **nie** są obsługiwane w AMP dla poczty e-mail.

## Funkcje media <a name="media-features"></a>

Lista funkcji [media](https://developer.mozilla.org/en-US/docs/Web/CSS/Media_Queries/Using_media_queries#Media_features) obsługiwanych w celu warunkowego stosowania reguł poprzez zapytania `@media`.
