...
يوضح هذا المستند ميزات CSS المدعومة حاليًا داخل رسائل AMP الإلكترونية.

## تطبيق CSS <a name="applying-css"></a>

### صفحة الأنماط الداخلية <a name="internal-stylesheet"></a>

عند استخدام صفحة أنماط داخلية، يتم تحديد CSS داخل علامة `<style amp-custom>` والتي توجد في علامة `<head>` للبريد الإلكتروني.

### الأنماط المدمجة <a name="inline-styles"></a>

بالإضافة إلى صفحة الأنماط الداخلية، يمكن تحديث أنماط مدمجة على أي عنصر باستخدام السمة [`style`](https://developer.mozilla.org/en-US/docs/Web/HTML/Global_attributes#attr-style).

### صفحة الأنماط الخارجية <a name="external-stylesheet"></a>

صفحات الأنماط الخارجية **غير** مدعومة في AMP للبريد الإلكتروني.

ولا يُسمح باستخدام `<link rel="stylesheet" href="...">` في أي مكان في البريد الإلكتروني.

## محددات CSS المدعومة<a name="supported-css-selectors"></a>
...
## خواص CSS المدعومة<a name="supported-css-properties"></a>
...
### القيود الإضافية <a name="additional-restrictions"></a>
...
[قاعدةat](https://developer.mozilla.org/en-US/docs/Web/CSS/At-rule) الوحيدة المدعومة حاليًا هي `@media`. راجع [ميزات الوسائط](#media-features) لمزيد من المعلومات.

### الخطوط المخصصة (`@font-face`) <a name="custom-fonts-font-face"></a>

الخطوط المدعومة **غير** مدعومة في AMP للبريد الإلكتروني.

## ميزات الوسائط <a name="media-features"></a>
