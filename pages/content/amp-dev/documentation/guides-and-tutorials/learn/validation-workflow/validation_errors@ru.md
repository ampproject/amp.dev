...
[Расширенные компоненты]({{g.doc('/content/amp-dev/documentation/components.html', locale=doc.locale).url.path}}) должны быть включены в AMP-документ как специальные элементы.
