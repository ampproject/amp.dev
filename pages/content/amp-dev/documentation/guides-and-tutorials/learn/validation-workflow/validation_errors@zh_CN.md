...
[扩展组件]({{g.doc('/content/amp-dev/documentation/components.html', locale=doc.locale).url.path}})
...
请参阅 [AMP 组件]({{g.doc('/content/amp-dev/documentation/components.html', locale=doc.locale).url.path}})。
