...
[tip type="note"]
This documentation covers actions and events for AMP websites, stories and ads. Read [Actions and events in AMP email](https://github.com/ampproject/amphtml/blob/main/spec/amp-email-actions-and-events.md) for the AMP email format.
[/tip]
...
<table>
  ...
  <tr>
    ...
    <td>Update's <code>amp-list</code>'s layout to <code>layout="CONTAINTER"</code> to allow <a href="https://github.com/ampproject/amphtml/blob/main/spec/../extensions/amp-list/amp-list.md#dynamic-resizing">dynamic resizing</a>.</td>
  </tr>
  <tr>
