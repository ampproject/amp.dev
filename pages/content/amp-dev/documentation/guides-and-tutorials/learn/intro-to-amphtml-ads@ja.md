...
**ゼロから作成する**: AMP HTML 広告は、[AMP HTML 広告仕様](a4a_spec.md)に沿って作成されている必要があります。デモとサンプルについては、[AMP by Example](/content/amp-dev/documentation/examples/documentation/amp-ad.md) で公開されているオープンソースの AMP HTML 広告テンプレートをご覧ください。
...
はい、公開されています。デザイン性に優れた AMP HTML 広告テンプレートが [Examples](/content/amp-dev/documentation/examples/documentation/amp-ad.md) で数多く公開されています。公開されているサンプルは、AMP の高度なコンポーネントを使用しています。
