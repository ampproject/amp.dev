...
See [Validate AMP Email]({{g.doc('/content/amp-dev/documentation/guides-and-tutorials/develop/validate_emails.md', locale=doc.locale).url.path}}) for more information.
