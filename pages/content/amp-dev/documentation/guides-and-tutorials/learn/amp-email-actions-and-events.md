...
[tip type="note"]
This documentation covers actions and events for the AMP email format. Read [Actions and events](https://github.com/ampproject/amphtml/blob/main/docs/spec/amp-actions-and-events.md) for AMP websites, stories and ads.
[/tip]
