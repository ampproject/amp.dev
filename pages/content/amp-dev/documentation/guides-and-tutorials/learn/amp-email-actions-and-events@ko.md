...
[tip type="note"] 이 문서는 AMP 이메일의 액션 및 이벤트를 설명합니다. AMP 웹사이트, 스토리 및 광고에 대한 자세한 내용은 다음 [액션 및 이벤트](https://github.com/ampproject/amphtml/blob/main/spec/amp-actions-and-events.md) 문서를 참조하세요. [/tip]
