...
- <a name="boilerplate"></a>Zawierać [kod standardowy AMP](https://github.com/ampproject/amphtml/blob/main/spec/amp-boilerplate.md) (`head > style[amp-boilerplate]` i `noscript > style[amp-boilerplate]`) w sekcji head. [🔗](#boilerplate)
...
[Dokumentacja AMP](https://github.com/ampproject/amphtml/blob/main/spec/amp-css-classes.md) zawiera informacje o znaczeniu nazw klas z prefiksem `amp-`. Stosowanie tych klas jest dozwolone i ma na celu umożliwienie dostosowania niektórych funkcji środowiska uruchomieniowego i rozszerzeń AMP.
...
Pełną listę niedozwolonych nazw identyfikatorów można wyświetlić, wyszukując hasło `mandatory-id-attr` [tutaj](https://github.com/ampproject/amphtml/blob/main/spec/../validator/validator-main.protoascii).
...
Szczegółowe informacje o obsługiwanych składnikach zawiera [specyfikacja składników AMP](https://github.com/ampproject/amphtml/blob/main/spec/./amp-html-components.md).
...
Szczegółowe informacje na temat systemu rozmieszczania zawiera artykuł [System układu AMP](https://github.com/ampproject/amphtml/blob/main/spec/./amp-html-layout.md).
...
Dowiedz się więcej o [działaniach i zdarzeniach AMP](https://github.com/ampproject/amphtml/blob/main/spec/./amp-actions-and-events.md).
...
Patrz [zasady przechowywania wersji AMP](https://github.com/ampproject/amphtml/blob/main/spec/amp-versioning-policy.md).
...
Szczegółowe informacje na temat obsługiwanych szablonów przedstawia [specyfikacja szablonów AMP](https://github.com/ampproject/amphtml/blob/main/spec/./amp-html-templates.md).
...
Aby dowiedzieć się więcej o składni i ograniczeniach dotyczących szablonu, odwiedź [dokumentację szablonu](https://github.com/ampproject/amphtml/blob/main/spec/./amp-html-templates.md#templates)<a>.</a>
