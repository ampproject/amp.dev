...
- [Canaux de publication](#release-channels)
    - [Nocturne](#nightly)
    - [Hebomadaire](#weekly)
        - [Versions d'essais et bêta](#experimental-and-beta-channels)
    - [Stable à long terme (lts)](#long-term-stable-lts)
- [Comment déterminer si un version comporte votre modification](#determining-if-your-change-is-in-a-release)
