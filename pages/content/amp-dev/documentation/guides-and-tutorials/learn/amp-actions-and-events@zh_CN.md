...
[tip type="note"] 本文档介绍适用于 AMP 网站、故事和广告的操作和事件。有关 AMP 电子邮件格式，请参阅 [AMP 电子邮件中的操作和事件](https://github.com/ampproject/amphtml/blob/main/docs/spec/amp-email-actions-and-events.md)。[/tip]
