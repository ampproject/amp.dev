...
Tutti i file AMP che includono funzioni sperimentali non supereranno la [convalida AMP]({{g.doc('/content/docs/fundamentals/validate.md', locale=doc.locale).url.path}}).
