...
Рекламные креативы AMPHTML требуют применения другого, значительно более простого, шаблонного кода, по сравнению с [обычными AMP-документами](https://github.com/ampproject/amphtml/blob/main/spec/amp-boilerplate.md):
...
Обратите внимание, что в тексте шаблона допускаются только те же изменения, что и в [общем шаблонном коде AMP](https://github.com/ampproject/amphtml/blob/main/spec/amp-boilerplate.md).
