...
<tr>
<td>Должны включать скрипт среды выполнения <code>&lt;script async src="https://ampjs.org/amp4ads-v0.js"></script></code> вместо <code>https://ampjs.org/v0.js</code>.</td>
...
- Как и в обычных документах AMP, тег `<head>` креатива должен содержать тег `<script async src="https://ampjs.org/amp4ads-v0.js"></script>`.
