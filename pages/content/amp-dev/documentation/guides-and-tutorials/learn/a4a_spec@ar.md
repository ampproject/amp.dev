...
<tr>
<td>يجب تضمين <code>&lt;script async src="https://ampjs.org/amp4ads-v0.js">&lt;/script></code> كنص برمجي لوقت التشغيل بدلًا عن <code>https://ampjs.org/v0.js</code>.</td>
...
- مثل مستند AMP عام، يجب أن تحتوي علامة `<head>` الخاصة بالتصميم على علامة `<script async src="https://ampjs.org/amp4ads-v0.js"></script>`.
