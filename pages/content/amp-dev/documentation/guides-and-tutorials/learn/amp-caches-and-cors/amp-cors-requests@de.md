...
**Hinweis**: Ein Beispiel für einen funktionierenden Code findest du unter [amp-cors.js](https://github.com/ampproject/amphtml/blob/main/build-system/server/amp-cors.js).
