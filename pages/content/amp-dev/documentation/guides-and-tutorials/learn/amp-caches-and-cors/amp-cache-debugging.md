...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>Contact the font provider and ask them to allowlist <a href="amp-cors-requests.md#cors-security-in-amp">all caches</a>.</td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>These components make cross-origin requests from the AMP Cache to your origin. By default, browsers block these requests. To allow these requests, emit <a href="https://developer.mozilla.org/en-US/docs/Web/HTTP/Access_control_CORS">CORS headers</a> that allowlist <a href="amp-cors-requests.md">all caches</a>.</td>
    </tr>
    <tr>
