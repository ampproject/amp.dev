...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td>Dynamic elements such as <a href="{{g.doc('/content/amp-dev/documentation/components/reference/amp-form.md', locale=doc.locale).url.path}}"><code>amp-form</code></a>, <a href="{{g.doc('/content/amp-dev/documentation/components/reference/amp-list.md', locale=doc.locale).url.path}}"><code>amp-list</code></a>, do not behave as expected.</td>
