...
<section class="main intro-image">
  <amp-img src="/static/img/the-blog.png" layout="responsive" height="0.78" width="1" />
</section>


<section class="main gallery-copy">
  <h2>Create great AMP experiences for all open web touchpoints</h2>
...
<section class="main image-gallery">
  <div class="images">
...
<section class="main made">
  <h1>This is What AMP HTML is made of</h1>
</section>

<section class="main made-sourcecode">
  [sourcecode:html]
    <!doctype html>
      <html ⚡>
        <head>
...
<section class="main made copy-center">
...
<section class="main made copy-right">
  <h2>Amp Cache</h2>
...
<section class="main usecase-headline">
  <h2>Explore use cases of Amp websites</h2>
</section>

<section class="main usecase-list">
  <div class="usecases">
    <div> <amp-img src="/static/img/band.png" layout="responsive" width="536" height="460"></amp-img> </div>
    <!-- <amp-img src="/static/img/education.png" layout="responsive" width="502" height="331"></amp-img>
    <amp-img src="/static/img/data.png" layout="responsive" width="468" height="343"></amp-img>
    <amp-img src="/static/img/choices.png" layout="responsive" width="372" height="409"></amp-img> -->
  </div>
</section>

<section class="main success-headline">
  <h2>Explore use cases of Amp websites</h2>
</section>
