...
- <a name="opacity"></a>contain `<style>body {opacity: 0}</style><noscript><style>body {opacity: 1}</style></noscript>` in their head tag. [🔗](https://github.com/ampproject/amphtml/blob/master/spec/#opacity)
