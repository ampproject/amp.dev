...
읽어보기: fallback에 관해 자세히 알아보려면 [자리표시자 및 Fallback]({{g.doc('/content/amp-dev/documentation/guides-and-tutorials/develop/placeholders.md', locale=doc.locale).url.path}}) 가이드를 참조하세요.
