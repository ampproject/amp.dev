...
읽어보기: [이미지의 대체 내용 및 자리표시자를 제공]({{g.doc('/content/amp-dev/documentation/guides-and-tutorials/develop/placeholders.md', locale=doc.locale).url.path}}) 하는 방법에 관해 자세히 알아보세요.
