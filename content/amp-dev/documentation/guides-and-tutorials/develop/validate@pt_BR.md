...
consulte o [guia sobre erros de validação de AMP](https://www.ampproject.org{{g.doc('/content/docs/troubleshooting/validation_errors.md', locale=doc.locale).url.path}}).
