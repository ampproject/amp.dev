...
เมื่อคุณ[ตรวจสอบความถูกต้องของหน้า AMP](/docs/guides/validate.html)
...
[สไตล์](/docs/guides/responsive/style_pages.html)และ
[การออกแบบ](/docs/guides/responsive/control_layout.html)ใน AMP
...
โปรดอ่าน[วิธีควบคุมการออกแบบ](/docs/guides/responsive/control_layout.html)และ
...
[ลักษณะการทำงานที่ต่างกันของการออกแบบ](/docs/guides/responsive/control_layout.html#size-and-position-elements)
...
(ดู
[ใช้โปรแกรมประมวลผล CSS ล่วงหน้า](/docs/guides/responsive/style_pages.html#use-css-preprocessors)เพิ่มเติม)
