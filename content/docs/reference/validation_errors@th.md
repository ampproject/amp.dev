...
เมื่อคุณ[ตรวจสอบความถูกต้องของหน้า AMP](/th/docs/guides/validate.html)
...
[องค์ประกอบขยาย](/docs/reference/components.html)
...
* [amp-twitter](/docs/reference/components/amp-twitter.html): `data-tweetid` หรือ `src`
* [amp-instagram](/docs/reference/components/amp-instagram.html): `data-shortcode` หรือ `src`
* [amp-iframe](/docs/reference/components/amp-iframe.html): `src` หรือ `srcdoc`
* [amp-youtube](/docs/reference/components/amp-youtube.html): `src` หรือ `data-videoid`
...
[สไตล์](/th/docs/guides/responsive/style_pages.html)และ
[การออกแบบ](/th/docs/guides/responsive/control_layout.html)ใน AMP
...
โปรดอ่าน[วิธีควบคุมการออกแบบ](/th/docs/guides/responsive/control_layout.html)และ
[ข้อกำหนดของระบบการออกแบบ AMP HTML](/docs/reference/spec/amp-html-layout.html)
...
[ลักษณะการทำงานที่ต่างกันของการออกแบบ](/th/docs/guides/responsive/control_layout.html)
...
(ดู
[ใช้โปรแกรมประมวลผล CSS ล่วงหน้า](//th/docs/guides/responsive/style_pages.html)เพิ่มเติม)
