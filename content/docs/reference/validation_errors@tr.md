...
[Genişletilmiş bileşenlerin](/docs/reference/extended.html), AMP dokümanına açık bir şekilde özel öğe olarak eklenmeleri gerekir.
...
Düzen türleri için izin verilmeyen öznitelikler [AMP HTML düzeni sistem spesifikasyonunda](https://github.com/ampproject/amphtml/blob/master/spec/amp-html-layout.md) açıklanmıştır.
