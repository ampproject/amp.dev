...
## Actions
The `amp-sidebar` exposes the following actions you can use [AMP on-syntax to trigger](https://github.com/ampproject/amphtml/blob/master/extensions/amp-sidebar/../../../src/spec/amp-actions-and-events.md):
