...
See [BindValidator](https://github.com/ampproject/amphtml/blob/master/extensions/amp-bind/./0.1/bind-validator.js) for the canonical set of bindable
...
The full expression implementation can be found in [bind-expr-impl.jison](https://github.com/ampproject/amphtml/blob/master/extensions/amp-bind/./0.1/bind-expr-impl.jison).
