...
## Actions
The `amp-live-list` exposes the following actions you can use [AMP on-syntax to trigger](https://github.com/ampproject/amphtml/blob/master/extensions/amp-live-list/../../../src/spec/amp-actions-and-events.md):
