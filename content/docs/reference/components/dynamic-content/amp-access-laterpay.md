...
<table>
  ...
  <tr>
    ...
    <td>&lt;object&gt;</td>
    <td>Allows the publisher to customize or localize the text present in the generated list of purchase options. See the [#localization](https://github.com/ampproject/amphtml/blob/master/extensions/amp-access-laterpay/Localization) section for more information.</td>
  </tr>
  <tr>
