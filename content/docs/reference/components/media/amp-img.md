...
Same as `srcset` attribute on the `img` tag. For more information see the [common `sizes` attribute docs](https://github.com/ampproject/amphtml/blob/master/builtins/../spec/amp-html-layout.md#sizes).
