...
Tutti gli stili devono essere inseriti nella sezione head del documento (leggi la sezione [Aggiungere stili a una pagina]({{g.doc('/content/docs/fundamentals/validate.md', locale=doc.locale).url.path}})).
