...
Leia mais: Para saber mais sobre os diferentes layouts em AMP, consulte o guia [Consultas de mídia e layout](/pt_br/docs/guides/responsive/control_layout.html##atributo-de-layout).
...
Leia mais: Para saber mais sobre o uso de srcset e tamanhos em páginas AMP, consulte o guia [Direção de arte com srcset, tamanhos e alturas](/pt_br/docs/guides/responsive/art_direction.html).
...
Leia mais: Para saber mais sobre a direção de arte em páginas AMP, consulte o guia [Direção de arte com srcset, tamanhos e alturas](/pt_br/docs/guides/responsive/art_direction.html).
...
Leia mais: Para saber mais sobre substitutos, consulte o guia [Substitutos e marcadores](/pt_br/docs/guides/responsive/placeholders.html).
