...
Dica: É muito fácil tornar os elementos responsivos nas AMP. Simplesmente coloque `layout="responsive"` neles. Para saber mais sobre o design responsivo nas AMP, acesse [Criar páginas AMP responsivas](/pt_br/docs/guides/responsive/responsive_design).
...
Importante: Verifique se os seus estilos são compatíveis com as AMP. Alguns estilos não são por motivos de desempenho (veja também [CSS compatível](/pt_br/docs/guides/responsive/style_pages.html)).
...
Leia mais: Saiba mais sobre [os layouts compatíveis com as AMP](/pt_br/docs/guides/responsive/control_layout.html)
...
Leia mais: Saiba mais sobre [Marcadores e substitutos](/pt_br/docs/guides/responsive/placeholders.html)
...
Leia mais: Saiba mais sobre [a direção artística com srcset e tamanhos](/pt_br/docs/guides/responsive/art_direction.html)
...
Leia mais: Saiba mais sobre como [validar e corrigir suas páginas AMP](/pt_br/docs/guides/validate.html)
