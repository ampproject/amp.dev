...
이제 AMP 스토리에 페이지를 추가하는 것은 어렵지 않을 것입니다. “The Joy of Pets”라는 이야기에 몇 페이지를 더 추가할텐데 특별히 어렵지는 않습니다. 아래의 설명을 바탕으로 **남은 페이지를 만들어보십시오**. 하다가 막혀도 걱정할 필요가 없습니다. 최종 완성본(<a href="https://github.com/ampproject/docs/blob/master/tutorial_source/amp-pets-story/pets-completed.html">pets-completed.html</a>)을 보고 베끼면 됩니다.
  ...
  <tr>
    <td width="60%">
      ...
      <ul>
        ...
        <li>3개의 요소 포함:
          <ul>
            <li><em>Cats</em>라는 제목의 <code>&lt;h1></code> 요소</li>
  ...
  <tr>
    <td width="60%">
      <ul>
        <li>2개의 레이어 포함:
      <ul>
        <li><b>레이어 1</b>: <a href="/ko/docs/tutorials/visual_story/create_cover_page.html#fill"><code>fill</code></a> 템플릿으로 만들고 반응형 전체 이미지 <a href="https://www.ampproject.org/ko/docs/reference/components/amp-img">amp-img</a> (<code class="filename">dog.jpg</code>, 720 x 1280px) 포함.</li>
        <li><b>레이어 2</b>: <a href="/ko/docs/tutorials/visual_story/create_cover_page.html#thirds"><code>thirds</code></a> 템플릿을 사용하고 두 개의 요소가 들어있습니다:
          <ul>
            <li><em>Dogs</em>라는 제목이 들어간 <code>&lt;h1></code> 요소.</li>
            <li><code>&lt;p></code> 요소에 <a href="/ko/docs/tutorials/visual_story/create_cover_page.htm#thirds"><code>grid-area</code></a>는 <a href="/ko/docs/tutorials/visual_story/create_cover_page.html#thirds"><code>lower-third</code></a>로 지정하고 다음의 문구를 넣습니다: <em>Dogs were probably the first tame animals. They have accompanied humans for some 10,000 years. Some scientists assert that all dogs, domestic and wild, share a common ancestor in the small South Asian wolf.</em></li>
          </ul>
        </li>
      </ul></li></ul>
    </td>
...
화면을 꽉 채우는 이미지와 그 위에 텍스트 배치하고 배경 음향을 어떻게 넣는지 보여줍니다.
...
<table class="noborder">
  <tr>
    <td width="60%">
      ...
      <li>3개의 레이어 포함:
      <ul>
        <li><b>레이어 1</b>: <a href="/ko/docs/tutorials/visual_story/create_cover_page.html#fill"><code>fill</code></a> 템플릿으로 만들고 반응형 전체 이미지 <a href="https://www.ampproject.org/ko/docs/reference/components/amp-img">amp-img</a> (<code class="filename">bird.jpg</code>, 720 x 1280px) 포함.</li>
        <li><b>레이어 2</b>: <a href="/ko/docs/tutorials/visual_story/create_cover_page.html#vertical"><code>vertical</code></a> 템플릿을 쓰고 하나의 요소를 포함:
          <ul>
            <li><em>Birds</em>라는 제목의 <code>&lt;h1></code></li>
          </ul>
        </li>
        <li><b>레이어 3</b>: <a href="/ko/docs/tutorials/visual_story/create_cover_page.html#vertical"><code>vertical</code></a> 템플릿을 쓰고 하나의 요소를 포함: 
          <ul>
            <li>다음의 구절을 보여주는 <code>&lt;q></code> 요소: <em>A bird is three things: Feathers, flight and song, And feathers are the least of these.--Marjorie Allen Seiffert</em></li>
            <li>이번 레이어는 <code>class="bottom"</code>을 써서 화면의 아랫부분에 문구를 배치합니다.</li> 
          </ul>
        </li>
      </ul></li>
      <li>페이지가 보여지는 동안 배경 음향을 재생합니다. 배경 음향을 포함하려면 <code>&lt;amp-story-page></code> 컴포넌트의 background-audio 속성을 설정하면 됩니다. 예를 들어, <code>background-audio="assets/bird-singing.mp3"</code></li>
      </ul>
    </td>
...
<table class="noborder">
  <tr>
    <td width="60%">
      ...
      <li>3개의 레이어를 포함:
      <ul>
        <li><b>레이어 1</b>: <code>fill</code> 템플릿으로 만들고 반응형 동영상 <a href="https://www.ampproject.org/ko/docs/reference/components/amp-video">amp-video</a> (<code class="filename">rabbit.mp4</code>) 포함.
          <ul>
            ...
            <li>동영상이 자동재생되도록 <code>autoplay</code> 속성을 넣습니다. AMP 스토리 유효성 검사 <strong>필수 사항</strong>.</li>
        ...
        <li><b>레이어 2</b>: <code>vertical</code> 템플릿을 쓰고 하나의 요소를 포함:
          <ul>
            <li><em>Rabbits</em>라는 제목의 <code>&lt;h1></code></li>
          </ul>
        </li>
        <li><b>레이어 3</b>: <code>vertical</code> 템플릿을 쓰고 하나의 요소를 포함:
          <ul>
