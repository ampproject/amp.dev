...
Learn more: See [Deep Dive into AMP Analytics]({{g.doc('/content/docs/analytics/analytics_amp/deep_dive_analytics.md', locale=doc.locale).url.path}}).
...
Learn more: Continue to learn about analytics with [Deep Dive into AMP Analytics]({{g.doc('/content/docs/analytics/analytics_amp/deep_dive_analytics.md', locale=doc.locale).url.path}}) and [Use Cases]({{g.doc('/content/docs/analytics/use_cases.md', locale=doc.locale).url.path}}).
