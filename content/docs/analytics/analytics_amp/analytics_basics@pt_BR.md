...
Saiba mais: Consulte [Informações detalhadas sobre o AMP Analytics]({{g.doc('/content/docs/analytics/analytics_amp/deep_dive_analytics.md', locale=doc.locale).url.path}}).
...
Saiba mais: Continue seu aprendizado sobre análises em [Informações detalhadas sobre o AMP Analytics]({{g.doc('/content/docs/analytics/analytics_amp/deep_dive_analytics.md', locale=doc.locale).url.path}}) e [Casos de uso]({{g.doc('/content/docs/analytics/use_cases.md', locale=doc.locale).url.path}}).
