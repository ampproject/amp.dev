...
Learn more: Continue to learn about analytics with [Analytics: the Basics]({{g.doc('/content/docs/analytics/analytics_amp/analytics_basics.md', locale=doc.locale).url.path}}).
