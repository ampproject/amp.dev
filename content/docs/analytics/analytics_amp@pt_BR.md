...
Conheça os recursos de análise no artigo [Analytics: conceitos básicos]({{g.doc('/content/docs/analytics/analytics_amp/analytics_basics.md', locale=doc.locale).url.path}}).
{% endcall %}
