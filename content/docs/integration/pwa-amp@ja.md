...
詳細情報: 詳しくは、AMP ページで [PWA の機能を有効にする方法](/ja/docs/integration/pwa-amp/amp-as-pwa.html)についてご覧ください。
...
詳細情報: `amp-install-serviceworker` を使って [AMP を PWA に接続する方法](/ja/docs/integration/pwa-amp/amp-to-pwa.html)についてご覧ください。
...
詳細情報: [PWA 内で AMP ページを消費する方法](/ja/docs/integration/pwa-amp/amp-in-pwa.html)についてご覧ください。
