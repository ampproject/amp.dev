...
Saiba como [ativar recursos de PWA](/pt_br/docs/integration/pwa-amp/amp-as-pwa.html) para suas páginas AMP.
{% endcall %}
...
{% call callout('Leia mais', type='read') %}
Saiba como [conectar AMP a um PWA](/pt_br/docs/integration/pwa-amp/amp-to-pwa.html) usando `amp-install-serviceworker`.
{% endcall %}
...
{% call callout('Leia mais', type='read') %}
Saiba como [usar páginas AMP em um PWA](/pt_br/docs/integration/pwa-amp/amp-in-pwa.html).
{% endcall %}
