...
funcionalidades adicionais que não passariam na [validação de AMP]({{g.doc('/content/docs/fundamentals/validate.md', locale=doc.locale).url.path}}) se fossem usadas de outra forma. Por exemplo:
