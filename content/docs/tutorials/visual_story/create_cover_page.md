...
{{ image('/static/img/docs/tutorials/amp_story/cover_layers.png', 416, 679, align='center half' ) }}
...
{{ image('/static/img/docs/tutorials/amp_story/pg0_layer1.jpg', 720, 1280, align='center half' ) }}

### Creating layer 2

So, we have our backdrop but now we need the second layer, which sits on top of the backdrop and contains our heading and byline.  To add our second layer, let's complete the same tasks we performed for layer 1, but instead of using the `fill` template, we'll use the **`vertical`** template. 

Before we go further, let's look at how we can arrange AMP and HTML elements in an `<amp-story-grid-layer>`.
...
<tr> 
   ...
   <code><pre>&lt;amp-story-grid-layer template="fill">
  &lt;amp-img src="dog.png"
      width="720" height="1280" 
      layout="responsive">
  &lt;/amp-img>
...
<tr>
    <td colspan="2"><h5>Vertical</h5></td>
</tr>
<tr> 
   ...
   <code><pre>&lt;amp-story-grid-layer template="vertical">
  &lt;p>element 1&lt;/p>
  &lt;p>element 2&lt;/p>
  &lt;p>element 3&lt;/p>
&lt;/amp-story-grid-layer></pre></code>
...
<tr>
    <td colspan="2"><h5>Horizontal</h5></td>
</tr>
<tr> 
    ...
    <code><pre>&lt;amp-story-grid-layer template="horizontal">
  &lt;p>element 1&lt;/p>
  &lt;p>element 2&lt;/p>
  &lt;p>element 3&lt;/p>
&lt;/amp-story-grid-layer></pre></code>
...
<code><pre>&lt;amp-story-grid-layer template="thirds">
...
<td>
{{ image('/static/img/docs/tutorials/amp_story/layer-thirds.png', 216, 341) }}
</td>
</tr>
</table>
