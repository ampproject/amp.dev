...
動的パラメータを含むトラッキング ピクセルをトラッキング URL に追加する必要がある場合は、[amp-pixel](/ko/docs/reference/components/amp-pixel) をご確認ください。貴社のテクノロジーと AMP を併用したいデベロッパーに向けて、サポートページに使用方法を掲載するようおすすめします。
...
この拡張機能の利用方法について詳しくは、[AMP By Example](https://ampbyexample.com/components/amp-call-tracking/) にアクセスするか、[ドキュメント](/ko/docs/reference/components/amp-call-tracking)をご覧ください。
