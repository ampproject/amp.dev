...
[Saiba mais sobre validação]({{g.doc('/content/docs/fundamentals/validate.md', locale=doc.locale).url.path}}) e o que fazer quando ocorrerem erros.
...
<div class="prev-next-buttons">
  ...
  <a class="button next-button" href="{{g.doc('/content/docs/getting_started/create/prepare_for_discovery.md', locale=doc.locale).url.path}}"><span class="arrow-next">Próxima</span></a>
</div>
