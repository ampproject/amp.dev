  ...
  <tr>
    <td width="60%">
      <ul>
        <li>Memuat 1 lapisan:
      <ul>
        <li>Mengimplementasikan template <a href="{{g.doc('/content/docs/getting_started/visual_story/create_cover_page.html#vertical', locale=doc.locale).url.path}}"><code>vertical</code></a>.</li>
        <li>Memuat 3 elemen:
          <ul>
            <li>Elemen <code>&lt;h1></code> dengan judul: <em>Kucing</em></li>
            <li>Elemen <a href="https://www.ampproject.org/docs/reference/components/amp-img">amp-img</a> responsif (<code class="filename">cat.jpg</code>, 720 x 1280 piksel)</li>
  ...
  <tr>
    <td width="60%">
      <ul>
        <li>Memuat 2 lapisan:
      <ul>
        <li><b>Lapisan 1</b>: Mengimplementasikan template <a href="{{g.doc('/content/docs/getting_started/visual_story/create_cover_page.html#fill', locale=doc.locale).url.path}}"><code>fill</code></a>, dan memuat elemen <a href="{{g.doc('/content/docs/reference/components/amp-img', locale=doc.locale).url.path}}">amp-img</a> responsif (<code class="filename">dog.jpg</code>, 720 x 1280 piksel).</li>
        <li><b>Lapisan 2</b>: Mengimplementasikan template <a href="{{g.doc('/content/docs/getting_started/visual_story/create_cover_page.html#thirds', locale=doc.locale).url.path}}"><code>thirds</code></a> dan memuat 2 elemen:
          <ul>
            <li>Elemen <code>&lt;h1></code> dengan judul: <em>Anjing</em></li>
            <li>Elemen <code>&lt;p></code> yang menetapkan <a href="{{g.doc('/content/docs/getting_started/visual_story/create_cover_page.html#thirds', locale=doc.locale).url.path}}"><code>grid-area</code></a> (area petak) yang mengisi <a href="{{g.doc('/content/docs/getting_started/visual_story/create_cover_page.html#thirds', locale=doc.locale).url.path}}"><code>lower-third</code></a> (pertiga bawah) dan memuat teks berikut: <em>Bisa jadi anjing adalah binatang jinak pertama. Mereka telah menemani manusia selama sekitar 10.000 tahun. Beberapa ilmuwan berpendapat bahwa semua anjing, entah jinak maupun liar, memiliki nenek moyang yang sama, yaitu serigala kecil dari Asia Selatan.</em></li>
          </ul>
        </li>
      </ul></li></ul>
    </td>
...
<table class="noborder">
  <tr>
    <td width="60%">
      ...
      <li>Memuat 3 lapisan:
      <ul>
        <li><b>Lapisan 1</b>: Mengimplementasikan template <a href="{{g.doc('/content/docs/getting_started/visual_story/create_cover_page.html#fill', locale=doc.locale).url.path}}"><code>fill</code></a>, dan memuat komponen <a href="https://www.ampproject.org/id/docs/reference/components/amp-img">amp-img</a> responsif (<code class="filename">bird.jpg</code>, 720 x 1280 piksel).</li>
        <li><b>Lapisan 2</b>: Mengimplementasikan template <a href="{{g.doc('/content/docs/getting_started/visual_story/create_cover_page.html#vertical', locale=doc.locale).url.path}}"><code>vertical</code></a> dan memuat satu elemen:
          <ul>
            <li>Elemen <code>&lt;h1></code> dengan judul: <em>Burung</em></li>
          </ul>
        </li>
        <li><b>Lapisan 3</b>: Mengimplementasikan template <a href="{{g.doc('/content/docs/getting_started/visual_story/create_cover_page.html#vertical', locale=doc.locale).url.path}}"><code>vertical</code></a> dan memuat satu elemen:
          <ul>
...
<table class="noborder">
  <tr>
    <td width="60%">
      ...
      <li>Memuat 3 lapisan:
      <ul>
        <li><b>Lapisan 1</b>: Mengimplementasikan template <code>fill</code> , dan memuat elemen <a href="https://www.ampproject.org/id/docs/reference/components/amp-video">amp-video</a> responsif (<code class="filename">rabbit.mp4</code>).
          <ul>
            <li>Ingatlah untuk menambahkan <strong>skrip wajib</strong> untuk komponen <a href="https://www.ampproject.org/id/docs/reference/components/amp-video">amp-video</a> di bagian <code>&lt;head></code> agar video dapat ditampilkan.</li>
