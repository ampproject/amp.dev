      ...
      <ul>
        ...
        <li>包含 3 个元素：
          <ul>
            ...
            <li>1 个自适应 <a href="https://www.ampproject.org/zh_cn/docs/reference/components/amp-img">amp-img</a>（<code class="filename">cat.jpg</code>，大小为 720 x 1280px）</li>
...
<table class="noborder">
  <tr>
    <td width="60%">
      ...
      <li>包含 3 个图层：
      <ul>
        <li><b>第 1 个图层</b>：实施 <code>fill</code> 模板，并包含一个自适应 <a href="https://www.ampproject.org/zh_cn/docs/reference/components/amp-video">amp-video</a> (<code class="filename">rabbit.mp4</code>)。
          <ul>
            <li>请务必在 <code><head></code> 部分为 <a href="https://www.ampproject.org/zh_cn/docs/reference/components/amp-video">amp-video</a> 组件添加<strong>必需脚本</strong>，以便视频可以正常显示。</li>
