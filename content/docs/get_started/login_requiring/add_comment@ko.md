...
폼 컴포넌트는 단순히 [amp-mustache](https://ampbyexample.com/components/amp-mustache/) 템플릿을 이용한 페이지 내에 그 값을 표현합니다.
...
<a class="go-button button" href="/ko/docs/get_started/login_requiring/logout.html">3단계로 계속</a>
