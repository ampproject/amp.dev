...
3.  Las redes publicitarias proporcionan creatividades creadas por los anunciantes. Los anunciantes pueden generar creatividades en el formato tradicional HTML o en el nuevo formato, [AMP HTML](/es/docs/ads/amphtml_ads.html). 

## Redes publicitarias compatibles

Las páginas AMP admiten una gran cantidad de [servidores de anuncios y redes publicitarias](/es/docs/ads/ads_vendors.html).

{% call callout('Nota', type='note') %}
¿Quieres integrar tu tecnología publicitaria con las páginas AMP? Consulta estas [directrices](/es/docs/ads/integration-guide.html).
{% endcall %}
...
Para obtener más información sobre los anuncios AMP HTML, consulta la guía [Anuncios AMP HTML](/es/docs/ads/amphtml_ads.html).
...
* [Monetizar tu página AMP con anuncios](/es/docs/ads/monetization.html)
* [Integrar tu tecnología con las páginas AMP para publicar anuncios de display](/es/docs/ads/adnetwork_integration.html)
* [Anuncios AMP HTML](/es/docs/ads/amphtml_ads.html)
