...
1.  首先要有一个 AMP 网页，然后发布商在该网页上创建一个广告位来展示广告。传统的做法是插入一段 JavaScript 代码，但在 AMP 中，发布商需要在其 AMP 网页中为特定的广告网络添加 [`<amp-ad>`](/zh_cn/docs/reference/components/amp-ad.html) 标记。要了解详细信息，请参阅[在您的 AMP 网页中利用广告获利](/zh_cn/docs/ads/monetization.html)指南。
...
3.  广告网络会投放广告主制作的广告。广告主可以使用传统的 HTML 制作广告，也可以采用新格式 [AMPHTML](/zh_cn/docs/ads/amphtml_ads.html) 制作广告。

## 支持的广告网络

AMP 支持很多[广告服务器和网络](/zh_cn/docs/ads/ads_vendors.html)。

{% call callout('注意', type='note') %}
希望将您的广告技术与 AMP 集成？请参阅这些[指南](/zh_cn/docs/ads/integration-guide.html)。
{% endcall %}
...
要详细了解 AMPHTML 广告，请参阅 [AMPHTML 广告](/zh_cn/docs/ads/amphtml_ads.html)指南。
...
* [在您的 AMP 网页中利用广告获利](/zh_cn/docs/ads/monetization.html)
* [与 AMP 集成以投放展示广告](/zh_cn/docs/ads/adnetwork_integration.html)
* [AMPHTML 广告](/zh_cn/docs/ads/amphtml_ads.html)
