...
Leer más: Obtén más información sobre los anuncios en la guía [Publicar anuncios en AMP]({{g.doc('/content/docs/ads/monetization.md', locale=doc.locale).url.path}}).
