...
<div class="prev-next-buttons">
  <a class="button prev-button" href="/pt_br/docs/fundamentals/add_advanced.html"><span class="arrow-prev">Anterior</span></a>
  <a class="button next-button" href="/pt_br/docs/fundamentals/add_advanced/review_code.html"><span class="arrow-next">Próxima</span></a>
</div>
