...
Al leer de nuevo la [especificación](es/docs/reference/spec.html) atentamente, nos damos cuenta de que utilizamos una etiqueta `<img>`, cuando deberíamos haber utilizado una etiqueta `<amp-img>`.
