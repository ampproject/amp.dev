...
Все стили [должны содержаться в заголовке документа](/docs/guides/validate.html#add-styles-to-a-page),
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td data-th="Description">Использование запрещено (за исключением <a href="#the-custom-fonts-exception">пользовательских шрифтов</a>).</td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td data-th="Description">Этот элемент запрещен, поскольку он снижает производительность.</td>
    </tr>
  </tbody>
</table>
