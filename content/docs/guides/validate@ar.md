...
بالإضافة إلى صلاحية AMP، قد تحتاج أيضًا إلى التأكد من أن مستند AMP [قابل للاكتشاف](/ar/docs/guides/deploy/discovery.html) لدى الأنظمة الأساسية التابعة لجهات خارجية.
