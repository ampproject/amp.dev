...
(راجع [إضافة أنماط إلى إحدى الصفحات](/ar/docs/guides/validate.html#add-styles-to-a-page)).
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td data-th="Description">غير مسموح باستخدامه باستثناء [الخطوط المخصصة](#the-custom-fonts-exception).</td>
    </tr>
    <tr>
